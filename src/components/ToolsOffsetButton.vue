<template>
	<div>
		...
		<b-popover :target="'offset' + index" ref="popover" placement="topleft" :show.sync="popoverShown" :title="$t('tools.offset.edit')" triggers="click">
			<b-form-group label-cols="3" :label="$t('tools.offset.x')">
				<b-input-group append="mm">
					<b-form-input v-model.number="xOffset" type="number" step="any" required></b-form-input>
				</b-input-group>
			</b-form-group>
			<b-form-group label-cols="3" :label="$t('tools.offset.y')">
				<b-input-group append="mm">
					<b-form-input v-model.number="yOffset" type="number" step="any" required></b-form-input>
				</b-input-group>
			</b-form-group>
			<b-form-group label-cols="3" :label="$t('tools.offset.z')">
				<b-input-group append="mm">
			...
			<b-row class="mt-2">
				<b-col class="text-center">
					<b-button variant="primary" :disabled="!offsetsValid" @click="setOffsets">
						<font-awesome-icon icon="check"></font-awesome-icon> {{$t('tools.offset.apply')}}
					</b-button>
				</b-col>
			</b-row>
		</b-popover>
