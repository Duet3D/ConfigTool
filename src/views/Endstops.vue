					...
					<tr v-for="i in 3">
						...
						<td>
							<b-form-radio-group buttons button-variant="outline-primary" v-model="template.drives[i - 1].endstop_type" :name="'endstopType' + i" class="w-100">
								...
								<b-form-radio value="1" class="w-100" v-b-tooltip.hover title="Endstop switch pulls signal from GND to +3.3V when triggered">Active high (NO switch)</b-form-radio>
								<b-form-radio value="2" class="w-100" v-b-tooltip.hover title="Endstop switch pulls signal from +3.3V to GND when triggered">Active low (NC switch)</b-form-radio>
