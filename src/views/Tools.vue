			...
			<table class="table mb-0">
				...
				<tbody>
					<tr v-for="(tool, index) in tools" :key="index">
						...
						<td class="pt-3">
							<b-form-checkbox-group v-if="extruders.length !== 0" :value="tool.extruders" @change="setToolExtruders({ index, extruders: $event })" buttons button-variant="outline-primary" size="sm" :name="'tool-extruders-' + index" :options="extruders"></b-form-checkbox-group>
